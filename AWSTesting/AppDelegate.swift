...
class AppDelegate: UIResponder, UIApplicationDelegate{
    ...
    func presentHomeController(){
        if let homeController = storyBoard.instantiateViewController(withIdentifier: "home") as? UINavigationController{
            self.window?.rootViewController = homeController
        }
    }
    
    func presentSignInController(){
        if let signInController = storyBoard.instantiateViewController(withIdentifier: "signin") as? UINavigationController{
